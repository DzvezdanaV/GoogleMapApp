...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun isPermisionGranted(permission: String): Boolean {
...
//        map.animateCamera(CameraUpdateFactory.newLatLng(gsixLocation))                 - Da se namesti vo centar lokacijata
//        map.animateCamera(CameraUpdateFactory.newLatLngZoom(gsixLocation, 15f))                  // Da se zumira
